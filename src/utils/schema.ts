export function getEventEntityId(
  eventName: string,
  txHash: string,
  logIndex: string
): string {
...
export function getLeagueEntityId(
  sportId: BigInt,
  countryName: string,
  leagueName: string
): string {
  return sportId
    .toString()
    .concat("_")
    .concat(countryName.concat("_").concat(leagueName));
}

export function getGameEntityId(
...
export function getConditionEntityId(
  coreAddress: string,
  conditionId: string
): string {
...
export function getParticipantEntityId(
  gameEntityId: string,
...
export function getOutcomeEntityId(
...
export function getSelectionEntityId(
  betEntityId: string,
  conditionId: string
): string {
...
export function getFreebetEntityId(
...
export function getLiquidityPoolNftEntityId(
  liquidityPoolAddress: string,
  leaf: string
): string {
